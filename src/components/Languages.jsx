  ...
  return (
    <section id="languages" className="relative py-24 sm:py-28">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -right-24 top-10 h-72 w-72 rounded-full bg-blush/60 blur-3xl" />
      </div>
            ...
            <Reveal key={lang.name} delay={i * 0.08}>
              <div className="glass rounded-[1.5rem] p-6 shadow-soft transition hover:shadow-glass">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <span className="rounded-full bg-lilac/80 px-3 py-1 text-xs font-semibold text-ac-lav">
                    {lang.level}
                  </span>
                </div>
