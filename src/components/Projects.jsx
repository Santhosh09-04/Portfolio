          ...
          {projects.map((project, i) => (
            <Reveal key={project.title} delay={i * 0.12} className="h-full">
              <TiltCard intensity={8} className="h-full">
                <article className="glass flex h-full flex-col overflow-hidden rounded-[1.75rem] shadow-soft [transform:translateZ(24px)] transition-shadow duration-300 hover:shadow-glass">
